...
2. Build the note from the template:
   ...
   - Insert only the Part 6 modules the file says apply (M14 opens every note; M15 in every mastectomy note; M16 in autologous notes; M17 in implant notes); delete every module and every risk item for a modality the patient is not receiving.
