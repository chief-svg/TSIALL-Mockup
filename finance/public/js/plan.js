...
window.PLAN = {
  ...
  debtFreeDate: '2027-02-27',        // 🏁 planned: interest-bearing debt (auto tail) and the 0% Discover balance both cleared Feb 27 (after the $12,500 vacation hold-back, 2026-09-15)
  ...
  bills: [
    ...
    // One-time: our share of the vacation, cash, needed before Nov 15 (added 2026-09-15). Held back from the Oct 27 check.
    { day: 14, amount: 12500, label: 'Vacation (our share)', category: 'Travel', payee: /vacation|travel|trip|resort|villa|airbnb|vrbo/i, from: '2026-11-14', until: '2026-11-15', oneTime: true }
  ],
  ...
  payments: [
    ...
    { date: '2026-10-27', account: 5486678, amount: 2100,                note: 'Only this much to Biz Plat: $12,500 is held back for the vacation payment (due before Nov 15)' },

    { date: '2026-11-15', account: 5486678, amount: 1150,                note: 'After the vacation $12,500 (Nov 14), the Nov 20 8018 statement, minimums and SoFi' },

    { date: '2026-11-27', account: 5486678, amount: 13300,   kill: true, note: 'PAYOFF — Amex Biz Plat (pay live balance)' },
    { date: '2026-11-27', account: 5486683, amount: 11600,               note: 'Remainder → Biz Gold' },

    { date: '2026-12-15', account: 5486683, amount: 1750,                note: 'After the Dec 20 8018 statement, minimums and SoFi' },

    { date: '2026-12-27', account: 5486683, amount: 5000,    kill: true, note: 'PAYOFF — Amex Biz Gold (pay live balance)' },
    { date: '2026-12-27', account: 'jess1991', amount: 6050, kill: true, note: 'PAYOFF — Jessica’s Citi 1991 (pay live balance; 27.99%* since Sep 29)' },
    { date: '2026-12-27', account: 5486703, amount: 13050,   kill: true, note: 'PAYOFF — Chase Sapphire. ALL CARDS DEAD except the 8018 living float (pay live balance)' },
    { date: '2026-12-27', account: 5486708, amount: 800,                 note: 'Remainder → SoFi' },

    { date: '2027-01-15', account: 5486708, amount: 4300,                note: 'Jessica’s check → SoFi' },

    { date: '2027-01-27', account: 5486708, amount: 5950,    kill: true, note: 'PAYOFF — SoFi (~$5,950*). Request official payoff quote w/ per-diem.' },
    { date: '2027-01-27', account: 'irs',   amount: 14150,   kill: true, note: 'PAYOFF — IRS (pay the balance shown in your IRS online account that day)' },
    { date: '2027-01-27', account: 5486718, amount: 4000,                note: 'Remainder → auto loan' },
    ...
    { date: '2027-02-15', account: 5486718, amount: 3500,                note: 'Jessica’s check → auto loan' },

    { date: '2027-02-27', account: 5486718, amount: 1450,    kill: true, note: 'PAYOFF — Wells Fargo auto (~$1,450*). Request payoff quote. 🏁 Interest-bearing debt gone' },
  ...
  projection: [
    ...
    { label: 'Oct ’26', date: '2026-10-31', debt: -102700, savings: 0 },
    { label: 'Nov ’26', date: '2026-11-30', debt: -74700,  savings: 0 },
    { label: 'Dec ’26', date: '2026-12-31', debt: -45800,  savings: 0,      note: 'cards + SoFi dead; IRS, auto, Discover remain' },
    { label: 'Jan ’27', date: '2027-01-31', debt: -17700,   savings: 10000,  note: 'interest-bearing debt gone Jan 27' },
    { label: 'Feb ’27', date: '2027-02-28', debt: -5600,       savings: 32500,  note: 'Discover cleared' },
