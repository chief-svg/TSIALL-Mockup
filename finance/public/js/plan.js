...
window.PLAN = {
  ...
  payments: [
    ...
    { date: '2027-01-15', account: 'irs',   amount: 4700,    kill: true, note: 'PAYOFF — IRS (pay the balance shown in your IRS online account that day)' },

    { date: '2027-01-27', account: 5486718, amount: 8900,    kill: true, note: 'PAYOFF — Wells Fargo auto (~$8,900*). Request payoff quote. 🏁 Interest-bearing debt gone' },
