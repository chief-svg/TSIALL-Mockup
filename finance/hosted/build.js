...
const scripts = ['js/plan.js', 'js/format.js', 'js/store.js', 'js/engine.js', 'js/charts.js', 'js/views/command.js', 'js/views/payoff.js', 'js/views/spending.js', 'js/views/projection.js', 'js/views/after.js', 'js/views/million.js', 'js/views/accounts.js'].map(r)
