...
- PocketSmith user id **882138**; account ids/roles are in plan.js; plan start 2026-09-07, debt −$120,561.66; interest-bearing debt (auto tail) and the Discover 0% balance both cleared **2027-02-27** = debt-free target (revised 2026-09-15 after the $12,500 vacation hold-back; 09-11: IB gone 01-27; 09-10: 01-15; original 2026-12-27). One-time bills: `plan.bills` entries with `from`/`until` (vacation $12,500 on 2026-11-14); user is in America/Chicago.
