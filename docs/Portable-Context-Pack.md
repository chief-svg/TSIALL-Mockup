# Portable Context Pack: Boards-Grade Breast Reconstruction Notes

Paste this whole file into a new chat session (Claude.ai or any Claude interface without file access) before pasting a patient history. It contains the standing instructions, the consult note template in the surgeon's voice, the interview and exam reminders, and the evidence the notes cite. Then paste the patient history and ask for the summary and the note.
...
# Evidence and oncology model (from the consult kit and protocol)
