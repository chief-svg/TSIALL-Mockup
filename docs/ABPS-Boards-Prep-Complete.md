...
Repository branch `claude/plastic-surgery-boards-checklist-du429b`, folder `docs/`: `Consult-Template-Final.md` (the template, v1.5 with Part 8 Case Log fields and modules M14 to M20: opening, mastectomy and nipple counseling, DIEP and implant procedure explanations, oncoplastic reduction with lumpectomy, flap options closed by prior surgery, removal of reconstruction implants with or without a nipple lift), `BOI-Coverage-Map.md` (every Booklet requirement mapped to its prompt), `Interview-Exam-Reminders.md`, `Breast-Reconstruction-Consult-Kit.md` (Sections 10 to 13 hold the oncology model and evidence), `ABPS-Oral-Boards-Compliance-Protocol.md`, `Note-Review-Log.md`, `Oncology-Timing-Algorithm.md`, `Clinic-Workflow.md`. Commands in `.claude/skills/`: `/patient-brief`, `/patient-update`, `/note-draft`, `/note-check`, `/patient-package`. For a chat session without files, paste `docs/Portable-Context-Pack.md`.
...
| `Consult-Template-Final.md` and `.pdf` | v1.5. The consolidated assessment-and-plan template in the user's voice: style rules, fixed lines, assessment block, eleven plan paragraphs, three risk lists, thirteen modules, sign-off check. Published page: https://claude.ai/artifact/LNb9JXD6C6zkEXxwuwUMxh |
...
**September 18, 2026.** Patient 1 was seen; the dictation was converted into the template and returned in chat (not stored in the repo). A fourth colleague's templates (Provider D) were reviewed and folded into template v1.3 as modules M14 to M17 (opening, mastectomy and nipple counseling, DIEP procedure explanation, implant procedure explanation) with additions to the risk lists and exam; the review and the rejected items are in `Note-Review-Log.md`. Patient 2 turned out to be a lumpectomy with oncoplastic reduction, so M18 (oncoplastic reduction) and M19 (flap options closed by prior surgery) were added with an oncoplastic risk list. Patient 4 (explant with nipple lift after implant reconstruction, one side radiated) added M20. Patient 3 is still to come.
...
**Oncoplastic reduction with lumpectomy, add:** persistent symptoms; positive margins requiring re-excision or completion mastectomy, which is harder after tissue rearrangement; fat necrosis and microcalcifications that can complicate future imaging and biopsy; partial or complete nipple necrosis and the need for a free nipple graft with loss of sensation and pigmentation; breakdown at the T-junction that could delay radiation; radiation-related shrinkage, firmness, and asymmetry of the treated breast; areolar wrinkling or deformity; recurrent hypertrophy with weight gain and change in appearance with weight change or pregnancy; an unexpected cancer in the contralateral reduction specimen.
...
### M18. Oncoplastic reduction with lumpectomy (breast-conserving notes)

I explained that her candidacy for breast conservation rests with Dr. [breast surgeon] and the oncology team, and that a lumpectomy is not a mastectomy: she will need radiation to the breast [per Dr. (radiation oncology)] and continued surveillance of both breasts with her breast surgeon, including the reduced contralateral breast. I explained that my role is partial breast reconstruction, filling the lumpectomy defect by rearranging her own breast tissue as a reduction, with the contralateral breast reduced in the same way at the same operation for symmetry, and that the treated breast is left slightly larger in anticipation of shrinkage from radiation. I explained that the reduction also reduces the weight of the breasts and repositions the breast tissue and the nipple higher on the chest wall in order to relieve her symptoms of [neck, shoulder, and back pain, shoulder grooving, and intertrigo]. I explained that the nipple is carried on a [superomedial] dermoglandular pedicle that supplies its blood flow and sensation and provides the remaining breast tissue, and that the Wise-pattern incisions around the areola, down the lower pole, and along the inframammary fold allow the skin to be redraped over the remaining gland higher on the chest. I anticipate removing about [ ] g from the [left, including the lumpectomy specimen,] and [ ] g from the right (body surface area [ ], Schnur threshold [ ] g per breast). [The intended result was demonstrated on her own breasts / no modeling software was used.] I explained that the lumpectomy specimen will be oriented and the cavity marked with clips, and that if the final margins are positive, then re-excision is more difficult after tissue rearrangement and may require re-excision through the same incisions or a completion mastectomy, in which case the reconstruction plan would change to [ ]. I explained that the contralateral reduction specimen is examined by pathology. [If genetics are pending: "I explained that the surgical plan will be finalized when the genetic result returns, because a pathogenic variant would change the recommendation toward mastectomy."] [If SN-N is long: "Given her sternal notch to nipple distance of ( ) cm, I explained that the risk of nipple loss is higher than usual, that a free nipple graft may be needed with loss of sensation and pigmentation, and that if the nipple is lost then it would be reconstructed at a later stage, and I emphasized these risks because a wound in the treated breast could delay her radiation."] Patient verbalized understanding.

### M19. Flap options closed by prior surgery (any note)

I explained that her prior [abdominoplasty / extensive liposuction] removes the abdomen as a donor site, so a DIEP flap is not possible, and that her prior [back lift / thoracic scars] crossing [the lateral inframammary fold] places local perforator flaps such as a LICAP or TDAP at higher risk of poor perfusion. [The remaining flap options, should she ever need a mastectomy, are ( ).] Patient verbalized understanding.

### M20. Removal of reconstruction implants, with or without a nipple lift (revision notes)

I explained the options after removal of her implants: removal with a flat closure; removal with excision of the excess skin and elevation of the nipple on the remaining mastectomy skin flap; removal with exchange for a smaller implant; removal with fat grafting at a later stage for contour; and no surgery. I explained that after mastectomy there is no breast tissue beneath the skin, so removal leaves a flat chest with a loose skin envelope and low nipples, and that elevation of the nipple depends entirely on the blood supply through the mastectomy skin flap, which [her transverse scars above the nipples / prior radiation to the ( ) side] compromise. I explained that ICG angiography will be used during surgery to judge that blood supply, that if the nipple cannot be elevated safely, then the implants will be removed and the incisions closed flat so she can heal, with elevation of the nipples revisited at a later stage, and that if there is concern for loss of the nipple, then the nipple will be removed and replaced as a free nipple graft with loss of sensation and possible loss of pigmentation. I explained that partial nipple necrosis is possible even when the lift proceeds. I explained that the capsule [will be removed in full / will be removed where it is thickened or calcified / will be left in place] and sent to pathology, [that her implants are ( ) and that textured implants carry a small risk of breast implant-associated anaplastic large cell lymphoma, so any fluid and the capsule will be sent for cytology and CD30]. I explained that radiated skin heals more slowly and that the lift on that side will be more conservative. Patient verbalized understanding and elected [ ].
