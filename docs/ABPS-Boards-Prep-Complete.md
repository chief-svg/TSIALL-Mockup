...
**Oncoplastic reduction with lumpectomy, add:** positive margins requiring re-excision or completion mastectomy, which is harder after tissue rearrangement; fat necrosis and microcalcifications that can complicate future imaging and biopsy; partial or complete nipple necrosis and the need for a free nipple graft with loss of sensation and pigmentation; breakdown at the T-junction that could delay radiation; radiation-related shrinkage, firmness, and asymmetry of the treated breast; recurrent hypertrophy with weight gain; an unexpected cancer in the contralateral reduction specimen.
